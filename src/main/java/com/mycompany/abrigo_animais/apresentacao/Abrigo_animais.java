            ...
            switch (choice) {
                ...
                case 1:
                    ...
                    while (opcaoContinuar == 1) {
                        ...
                        if (choice_atd == 1)
                            atendentes.add(CriarCadastroAtendente());
                        else if (choice_atd == 2)
                            AlterarCadastroAtendente(atendentes);
                        else if (choice_atd == 3)
                            listarAtendentes(atendentes);
                        else
                            out.println("Opcao Invalida.");

                        System.out.println("\nDeseja continuar com Atendentes?\n1 - Sim | 2 - Nao");
                ...
                case 2:
                    opcaoContinuar = 1;
                    while (opcaoContinuar == 1) {
                        int choice_med = menu_dados();  // Note que é melhor pedir dentro do loop
                        if (choice_med == 1)
                            vets.add(CriarMedico());  // CriarMedico trata internamente erros de data, etc.
                        else if (choice_med == 2)
                            AlterarCadastroMedico(vets);
                        else if (choice_med == 3)
                            listaMedicos(vets);
                        else
                            out.println("Opcao Invalida.");

                        System.out.println("\nDeseja continuar com Veterinario?\n1 - Sim | 2 - Nao");
                        opcaoContinuar = input.nextInt();
                        input.nextLine();
                    }
                    break;
                ...
                case 3:
                    ...
                    while (opcaoContinuar == 1) {
                        ...
                        if (choice_adt == 1)
                            adotantes.add(CriarCadastroPessoa());
                        else if (choice_adt == 2)
                            AlterarCadastroPessoa(adotantes);
                ...
                case 4:
                    ...
                    while (opcaoContinuar == 1) {
                        ...
                        if (choice_ptr == 1)
                            prontuarios.add(CriarProntuario());
                        else if (choice_ptr == 2)
                            AlterarProntuario(prontuarios);
                        else if (choice_ptr == 3)
                            listaProntuarios(prontuarios);
                        else
                            out.println("Opcao Invalida.");

                        System.out.println("\nDeseja continuar com Prontuarios?\n1 - Sim | 2 - Nao");
                        opcaoContinuar = input.nextInt();
                        input.nextLine();
                    }
                    break;
                case 5:
                    ...
                    while(opcaoContinuar == 1) {
                        ...
                        if (choice_animal == 1)
                            animais.add(CriarAnimal());
                        else if (choice_animal == 2)
                            AlterarCadastroAnimal(animais);
                        else if (choice_animal == 3)
                            listarAnimais(animais);
                        else
                            out.println("Opcao Invalida.");

                        System.out.println("\nDeseja continuar com Animais?\n1 - Sim | 2 - Nao");
                        opcaoContinuar = input.nextInt();
                        input.nextLine();
                    }
                    break;
                case 6:
                    ...
                    while (opcaoContinuar == 1) {
                        ...
                        if (choice_agenda == 1)
                            agenda.add(CriarAgenda());
                        else if (choice_agenda == 2)
                            AlterarCadastroAgenda(agenda);
                        else if (choice_agenda == 3)
                            listarAgendas(agenda);
                        else
                            System.out.println("Opcao invalida.");

                        System.out.println("\nDeseja continuar com Agenda?\n1 - Sim | 2 - Nao");
                        opcaoContinuar = input.nextInt();
                        input.nextLine();
                    }
                    break;
